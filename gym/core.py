...
class Wrapper(Env):
    ...
    def __init__(self, env):
        ...
        if hasattr(self.env, 'sample_action'):
            self.sample_action=self.env.sample_action
        if hasattr(self.env, 'update_adversary'):
            self.update_adversary=self.env.update_adversary
        if hasattr(self.env, 'adv_action_space'):
            self.adv_action_space=self.env.adv_action_space
        if hasattr(self.env, '_adv_bindex'):
            self._adv_bindex = self.env._adv_bindex
