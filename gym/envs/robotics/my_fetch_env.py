...
from gym.envs.robotics import rotations, my_robot_env, utils
# debug
...
class FetchEnv(my_robot_env.RobotEnv):
    ...
    def _render_callback(self):
        ...
        # visualize object force
        # object_id=self.sim.model.site_name2id('object0')
        # self.sim.model.site_pos[object_id]=self.sim.data.get_site_xpos('object0')
        # print('object0', self.sim.model.site_pos[object_id])
    ...
    def update_adversary(self, new_adv_max):
        ...
        adv_action_space = self.adv_action_space.shape[0]
        high_adv = np.ones(adv_action_space) * adv_max_force
        low_adv = -high_adv
        self.adv_action_space = spaces.Box(low_adv, high_adv)
        print('after update', self.adv_action_space.high)
